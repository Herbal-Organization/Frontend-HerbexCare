...
function NewsletterSection() {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 pb-20">
      <div className="bg-primary rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl shadow-primary/20">
        <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
          ...
          <form className="w-full max-w-md flex flex-col sm:flex-row gap-3 mb-4" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex-1 rounded-full px-6 py-4 outline-none text-slate-900 font-medium placeholder-slate-400 focus:ring-4 focus:ring-white/30 transition-shadow"
              required
            />
            <button 
              type="submit" 
