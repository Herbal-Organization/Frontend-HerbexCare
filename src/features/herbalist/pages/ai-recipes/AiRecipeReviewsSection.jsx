...
import useAiRecipeReviews from "./useAiRecipeReviews";

function AiRecipeReviewsSection({ recipeId }) {
  const {
    reviews,
    myReview,
    isLoading,
...
export default AiRecipeReviewsSection;
