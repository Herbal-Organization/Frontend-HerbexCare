...
const PatientAiChat = () => {
  ...
  return (
    <div className="p-0 sm:p-4 lg:p-6 max-w-7xl mx-auto h-[calc(100vh-140px)] flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="hidden md:block mb-4">
        <h2 className="text-2xl font-bold text-slate-800">AI Herbal Chat</h2>
