...
const OrderCard = ({
  ...
  if (compact) {
    return (
      <div className="group rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm transition-all duration-200 hover:bg-slate-50 dark:hover:bg-slate-700/50 hover:shadow-md">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <p className="font-extrabold text-slate-900 dark:text-slate-100 text-lg">Order #{id}</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-700">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs font-bold text-slate-700 dark:text-slate-200 transition-all duration-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:shadow-sm"
            >
  ...
  return (
    <div className="group transition-all duration-200 hover:bg-slate-50 dark:hover:bg-slate-800/50">
      <div className="hidden px-5 py-4 lg:grid lg:grid-cols-[1.1fr_1fr_0.8fr_0.8fr_0.9fr_0.9fr_120px] lg:items-center lg:gap-4">
        <div>
          <p className="font-extrabold text-slate-900 dark:text-slate-100">Order #{id}</p>
        ...
        <span className="inline-flex w-fit rounded-full border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-1 text-xs font-bold text-slate-700 dark:text-slate-300">
        ...
        <select
          ...
          className="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs font-black text-slate-900 dark:text-slate-100 outline-none transition-all duration-200 focus:ring-4 focus:ring-emerald-500/20 disabled:opacity-50"
          disabled={isLoading}
        >
      ...
      <div className="hidden px-5 py-4 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:hidden gap-4">
        ...
        <div className="col-span-2 md:col-span-1 flex items-center justify-between">
          ...
          <Link
            to={`/herbalist/dashboard/orders/${id}`}
            className="ms-2 inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs font-bold text-slate-700 dark:text-slate-200 transition-all duration-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:shadow-sm"
          >
            <FaChevronRight />
          </Link>
        </div>
