...
function RecipesGrid({
  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 gap-5 pb-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 xl:grid-cols-4">
  ...
  return (
    <Motion.div
      ...
      initial="hidden"
      animate="visible"
      className="grid grid-cols-1 gap-5 pb-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 xl:grid-cols-4"
    >
      {recipes.map((recipe) => (
        <RecipeCard
